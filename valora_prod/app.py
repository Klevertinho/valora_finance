...
def create_app():
    ...
    public_endpoints = {
        ...
        "robots_txt", "sitemap_xml", "stripe_webhook", "assinar_plano", "static"
    }
    ...
    def plan_label(plan):
        return {"inicial": "Inicial", "profissional": "Profissional"}.get(plan, "Profissional")
...
"""
    ...
    def assinar_plano(plan):
        ...
        if not session.get("user_id"):
            return redirect(url_for("cadastro", plan=plan))
        try:
